...
export default function LokasiBerkas(props) {
                ...
                api.post("/location", formData)
                    .then((res) => {
                        ...
                        setSnackbar({
                            open: true,
                            message:
                                "Lokasi Penyimpanan Baru Berhasil Ditambahkan",
                            status: "success",
                        });
                        getDataUsage();
                    })
    ...
    function editLokasiBerkas() {
        ...
        if (valid.isValidated) {
            ...
            try {
                props.onLoading(true);
                api.put(`/location/${isUpdate}`, formData)
                    .then((res) => {
                        props.onLoading(false);
                        handleDialog("close");
                        setRuangan(0);
                    ...
                    <DialogContent>
                        ...
                        >
                            ...
                            <TextField
                                ...
                                onChange={(ev) =>
                                    setSubPenyimpanan(ev.target.value)
                                }
                                fullWidth
                            >
